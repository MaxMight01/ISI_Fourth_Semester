...
\begin{titlepage}
    ...
    \begin{center}
        \vspace*{\fill}
        {\Huge\bfseries\color{black!90} \MakeUppercase{Introduction to Linear Models and Regression}\par}
        \vspace{0.5cm}
        {\Large\color{black!90} Moutushi Chatterjee, notes by Ramdas Singh\par}
        \vspace{0.5cm}
        {\large\color{black!90} Fourth Semester\par}
        \vspace*{\fill}
    \end{center}
\end{titlepage}
